...
public:
    ...
    void loadSTL(const QString &fileName); // 声明loadSTL函数
    vtkSmartPointer<vtkActor> getActor(); // 声明getActor函数
...
private:
    ...
    vtkSmartPointer<vtkSTLReader> stlReader; // 添加STL reader
    vtkSmartPointer<vtkPolyDataMapper> mapper; // 添加mapper
    vtkSmartPointer<vtkActor> actor; // 添加actor
};  
